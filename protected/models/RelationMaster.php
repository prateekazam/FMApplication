 ...
 * @property string $FAMILY_REL_NAME
...
class RelationMaster extends CActiveRecord {
    ...
    public function rules() {
        ...
        return array(
            array('FAMILY_REL_ID, FAMILY_REL_DESC, FAMILY_REL_NAME, CREATED_BY', 'required'),
            array('FAMILY_REL_ID', 'numerical', 'integerOnly' => true),
            array('FAMILY_REL_DESC, FAMILY_REL_NAME', 'length', 'max' => 200),
            array('CREATED_BY', 'length', 'max' => 100),
            array('CREATED_DATE', 'safe'),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('FAMILY_REL_ID, FAMILY_REL_DESC, FAMILY_REL_NAME, CREATED_BY, CREATED_DATE', 'safe', 'on' => 'search'),
        );
    }
    ...
    public function attributeLabels() {
        return array(
            ...
            'FAMILY_REL_NAME' => 'Family Rel Name',
    ...
    public function search() {
        ...
        $criteria->compare('FAMILY_REL_NAME', $this->FAMILY_REL_NAME, true);
