...
-- -----------------------------------------------------
-- Table `mydb`.`FM_USER_PHOTOS`
-- -----------------------------------------------------
CREATE  TABLE IF NOT EXISTS `mydb`.`FM_USER_PHOTOS` (
  `USER_PHOTO_ID` INT NOT NULL AUTO_INCREMENT ,
  `USER_ID` INT NOT NULL ,
  `IMAGE_NAME` VARCHAR(45) NOT NULL ,
  `IMAGE_PATH_LOC` VARCHAR(500) NOT NULL ,
  `FOLDER_NAME` VARCHAR(100) NOT NULL ,
  PRIMARY KEY (`USER_PHOTO_ID`) ,
  INDEX `FM_USER_PHOTO_FOR_KEY_idx` (`USER_ID` ASC) ,
  CONSTRAINT `FM_USER_PHOTO_FOR_KEY`
    FOREIGN KEY (`USER_ID` )
    REFERENCES `mydb`.`FM_USER_BASIC_INF` (`USER_ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
